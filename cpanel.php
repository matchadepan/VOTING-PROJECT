...
<html lang="en">
  <head>
    ...
    <title>E Voting Kades Ds. Kemiri 2024</title>
    ...
    " role="navigation">
      <div class="container">
        ...
        <div class="navbar-header">
          <a href="cpanel.php" class="navbar-brand headerFont text-lg"><strong>E Voting Kades Ds. Kemiri 2024</strong></a>
        </div>

        <div class="collapse navbar-collapse" id="example-nav-collapse">
          <ul class="nav navbar-nav">
            
             <li><a href="nomination.html"><span class="subFont"><strong>Kandidat</strong></span></a></li>
      ...
      <div class="row">
        <div class="col-sm-12" style="border:2px solid gray;">
          ...
          <div class="page-header">
            <h2 class="specialHead">STATISTIC VOTING</h2><br>
            ...
            <?php
              ...
              else
              {
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>Rizky Maulana</strong><br>";
                  echo "
                  <div class='progress'>
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>Aldi Firmansyah</strong><br>";
                  echo "
                  <div class='progress'>
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>Iqbal Prayoga</strong><br>";
                  echo "
                  <div class='progress'>
